...
local WPIPEPATH = BioInd.entitypath .. "wood_products/wood_pipe/"
...
woodpipecoverspictures = function()
  return
  {
    north =
    {
      ...
      {
        {
          filename = WPIPEPATH .. "pipe-cover-north.png",
          priority = "extra-high",
          width = 64,
          height = 64,
          hr_version =
          {
            filename = WPIPEPATH .. "hr-pipe-cover-north.png",
            priority = "extra-high",
            width = 128,
            height = 128,
            scale = 0.5
    ...
    east =
    {
      ...
      {
        {
          filename = WPIPEPATH .. "pipe-cover-east.png",
          priority = "extra-high",
          width = 64,
          height = 64,
          hr_version =
          {
            filename = WPIPEPATH .. "hr-pipe-cover-east.png",
            priority = "extra-high",
            width = 128,
            height = 128,
            scale = 0.5
    ...
    south =
    {
      ...
      {
        {
          filename = WPIPEPATH .. "pipe-cover-south.png",
          priority = "extra-high",
          width = 64,
          height = 64,
          hr_version =
          {
            filename = WPIPEPATH .. "hr-pipe-cover-south.png",
            priority = "extra-high",
            width = 128,
            height = 128,
            scale = 0.5
    ...
    west =
    {
      ...
      {
        {
          filename = WPIPEPATH .. "pipe-cover-west.png",
          priority = "extra-high",
          width = 64,
          height = 64,
          hr_version =
          {
            filename = WPIPEPATH .. "hr-pipe-cover-west.png",
            priority = "extra-high",
            width = 128,
            height = 128,
            scale = 0.5
...
BI.additional_entities[setting].wood_pipe_to_ground = {
  ...
  fluid_box = {
    base_area = 1,
    pipe_covers = woodpipecoverspictures(),
    pipe_connections = {
      { position = {0, -1} },
      {
        position = {0, 1},
