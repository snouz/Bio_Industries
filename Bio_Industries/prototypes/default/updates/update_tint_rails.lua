...
------------------------------------------------------------------------------------
--~ -- Straight rails
--~ entity = data.raw["straight-rail"]["straight-rail"]
--~ entity.icon = ICONPATH .. "entity/straight-rail-concrete.png"
--~ entity.icon_size = 64
--~ entity.icon_mipmaps = 0
--~ entity.BI_add_icon = true

--~ -- Curved rails
--~ entity = data.raw["curved-rail"]["curved-rail"]
--~ entity.icon = ICONPATH .. "entity/curved-rail-concrete.png"
--~ entity.icon_size = 64
--~ entity.icon_mipmaps = 0
--~ entity.BI_add_icon = true
...
--~ entity.icon = ICONPATH .. "entity/rail-concrete.png"
--~ entity.icon_size = 64
--~ entity.icon_mipmaps = 0
