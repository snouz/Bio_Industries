...
------------------------------------------------------------------------------------
--                              Create solar entities!                            --
------------------------------------------------------------------------------------
-- Solar farm
BI.optional_entities[setting].solar_farm = {
  type = "solar-panel",
...
-- Huge accumulator
BI.optional_entities[setting].large_accumulator = {
  type = "accumulator",
...
-- Huge substation
BI.optional_entities[setting].huge_substation = {
  type = "electric-pole",
...
BI.optional_entities[setting].solar_mat = {
  type = "tile",
  name = "bi-solar-mat",
...
-- Solar plant + boiler
BI.optional_entities[setting].solar_boiler = {
  type = "boiler",
