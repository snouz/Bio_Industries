...
--LARGE BIO GARDEN
...

  {
    ...
    energy_source = {
      type = "electric",
      usage_priority = "secondary-input",
      emissions_per_minute = -9.5, -- the "-" means it Absorbs pollution.
    },
    energy_usage = "40kW",
    ingredient_count = 1,
    module_specification = {
...

  {
    ...
    BI_add_icon = true,
    flags = {"placeable-neutral", "placeable-player", "player-creation"},
    minable = {hardness = 12.8, mining_time = 30, result = "bi-bio-garden-huge"},
    ...
    energy_source = {
      type = "electric",
      usage_priority = "secondary-input",
      emissions_per_minute = -90.3, -- the "-" means it Absorbs pollution.
    },
    energy_usage = "320kW",
    ingredient_count = 1,
