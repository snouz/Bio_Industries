...
BioInd.show("Changing localization for", v)
  ...
  -- This is only necessary for the old version! IR2 disables only the vanilla tech
  -- "solar-energy", but we unlock our stuff with different techs in the new version.
  --~ ------------------------------------------------------------------------------------
  ...
  --~ ------------------------------------------------------------------------------------
  --~ thxbob.lib.tech.add_recipe_unlock ("ir2-solar-energy-1", "bi-solar-boiler")
