...
------------------------------------------------------------------------------------
--- Basic Dart
BI.optional_entities[setting].dart_magazine_basic = {
  type = "ammo",
...
--- Standard Dart
BI.optional_entities[setting].dart_magazine_standard = {
  type = "ammo",
...
--- Enhanced Dart
BI.optional_entities[setting].dart_magazine_enhanced = {
  type = "ammo",
...
--- Poison Dart
BI.optional_entities[setting].dart_magazine_poison = {
  type = "ammo",
...
--                                   Dart turret                                  --
------------------------------------------------------------------------------------
BI.optional_entities[setting].dart_turret = {
  type = "ammo-turret",
  name = "bi-dart-turret",
...
--                                   Dart rifle                                   --
------------------------------------------------------------------------------------
BI.optional_entities[setting].dart_rifle = {
  type = "gun",
  name = "bi-dart-rifle",
...
------------------------------------------------------------------------------------
-- Wood fence
BI.optional_entities[setting].wooden_fence = {
  type = "wall",
