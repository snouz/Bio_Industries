...
data:extend({
  ...
  ---- Arboretum Area Overlay
  {
    ...
    folded_animation = {
      layers = {
        {
          filename = ENTITYPATH .. "biofarm/arboretum.png",
          priority = "low",
          width = 280,
          height = 320,
          frame_count = 1,
          ...
          shift = {0, 0},
          hr_version ={
            filename = ENTITYPATH .. "biofarm/hr_arboretum.png",
            priority = "low",
            width = 560,
            height = 640,
            frame_count = 1,
        ...
        {
          filename = ENTITYPATH .. "biofarm/arboretum_shadow.png",
          priority = "low",
          width = 280,
          height = 320,
          frame_count = 1,
          ...
          draw_as_shadow = true,
          hr_version ={
            filename = ENTITYPATH .. "biofarm/hr_arboretum_shadow.png",
            priority = "low",
            width = 560,
            height = 640,
            frame_count = 1,
    ...
    working_visualisations = {
      {
        ...
        animation = {
          layers = {
            {
              filename = ENTITYPATH .. "biofarm/arboretum_light.png",
              width = 280,
              height = 320,
              scale = 1,
              shift = {0, 0},
              hr_version = {
                filename = ENTITYPATH .. "biofarm/hr_arboretum_light.png",
                width = 560,
                height = 640,
                scale = 0.5,
                shift = {0, 0},
